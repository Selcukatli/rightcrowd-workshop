...
export default class TypeBuilder {
    ...
    BrandGuideline: ClassViewer<'BrandGuideline', "name" | "toneOfVoice" | "primaryColor" | "secondaryColor" | "styleDescription">;
    
    SlideContent: ClassViewer<'SlideContent', "title" | "content" | "speakerNotes" | "imagePrompt">;
    
    SlideSpec: ClassViewer<'SlideSpec', "title" | "keyPoints" | "suggestedVisual">;
    ...
    constructor() {
        this.tb = new _TypeBuilder({
          classes: new Set([
            "BrandGuideline","SlideContent","SlideSpec",
          ]),
          enums: new Set([
        ...
        this.BrandGuideline = this.tb.classViewer("BrandGuideline", [
          "name","toneOfVoice","primaryColor","secondaryColor","styleDescription",
        ]);
        
        this.SlideContent = this.tb.classViewer("SlideContent", [
          "title","content","speakerNotes","imagePrompt",
        ]);
        
        this.SlideSpec = this.tb.classViewer("SlideSpec", [
          "title","keyPoints","suggestedVisual",
        ]);
